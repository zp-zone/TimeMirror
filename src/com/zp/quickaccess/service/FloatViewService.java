...
public class FloatViewService extends Service {
	 ...
	 * 如果不是桌面 ，悬浮窗设置的为不隐藏(isHided为true)那么就需要判断悬浮窗是否正在显示(FloatViewManager.isSmallWindowAdded为true)，如果正在显示，那么将其移除
	 * 
	 * 需要注意的是：悬浮窗体的添加和删除都是通过FloatViewManager来实现的，其中添加和删除操作必须成对出现
	 * 尤其是FloatViewManager会在多个类中使用，所以其函数的封装一定要保证这种成队的特点
